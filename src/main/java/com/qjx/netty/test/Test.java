...
/**
 * Created by qincasin on 2020/10/13.
 * 网络字节序测试
 */
public class Test {
...
//        test();
        ...
        //
//        byte[] bytes2 = toBytes("3");
//        System.out.println(Arrays.toString(bytes2));

    }

    private static void testCrc() {
        byte[] bytes3 = "031F8607650488066620003F190102FFB0FF30FF80220242EA3CFC41FE9EBF80000007".getBytes();
        int c = 0;
        for (byte b : bytes3) {
            c+=b;
        }
...
//        int a = 0x30FF8022 ;
        ...
        byte[] bytes = FormatTransfer.toHH(a,3);
        System.out.println(Arrays.toString(bytes));
        float f1 = FormatTransfer.hBytesToFloat(buffer.array());
        System.out.println(f1);
        //031F8607650488066620003F190102FFB0FF30FF80220242EA3CFC41FE9EBF80000007B7DA
        //031 F8607650 488066620003F190102FF B0FF30FF80220242EA3CFC41FE9EBF80000007B7DA
        //031 F8607650 4880666200 03F19010 2FF B0FF30FF80220242EA3CFC41FE9EBF80000007B7DA

        byte[] bytes1 = "031F8607650488066620003F190102FFB0FF30FF80220242EA3CFC41FE9EBF80000007B7DA".getBytes();
        System.out.println(bytes1);
        int i = Integer.parseInt("FF", 16);
        System.out.println(i);

//        byte[] byte2 = FormatTransfer.toHH("0x500x200x30".getBytes(),3);
    }
